...
class DFs (DFs_procesar, DFs_graficar):
    def __init__(self, fecha_inicial='', fecha_final='', fecha_archivo='', indicadores=['positivos', 'activos', 'recup', 'fallecidos'], mostrar_graficas=False, verboso=False):
    ...
    def graficar_datos(self):
        ...
        lista_colores = {'cantones-activos': 'OrRd', 'cantones-recup': 'Greens', 'cantones-positivos': 'Purples', 'cantones-fallecidos': 'Greys'}
...
Data = DFs('6', fecha_archivo='19/07/2021', mostrar_graficas=True, verboso=True)
Data.main()
